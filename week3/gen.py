...
main_df.to_csv(os.path.join(DATA_DIR, "battery_main_binned20.csv"), index=False)
phys_df.to_csv(os.path.join(DATA_DIR, "battery_phys_resampled200.csv"), index=False)
